                                        ...
                                        <div class="row  mt-1">
                                            <div class="col-md-3 col-12">
                                                <div class="">
                                                    ...
                                                    <input type="email" id="email" name="email" class="form-control" value="{{ old('email', isset($customer) ? $customer->email : '') }}" required maxlength="25">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="">
                                                    ...
                                                    <input type="text" id="address1" name="address1" class="form-control" value="{{ old('address1', isset($customer) ? $customer->address1 : '') }}" required maxlength="50">
