...
<head>
    ...
    <style>
        ...
        th {
            ...
            margin: 10px;
            height: 60px;
            border-top: 1px solid #1845eb;
            border-bottom: 1px solid #1845eb;
        }
        ...
        <table>
            ...
            <tr style="height:80px">
                <td style="width: 150%;">
                    ...
                    <p style="font-size:24px; margin-top:5px;"><b style="color: green;">&nbsp; NEXZO-APP</b></p>
