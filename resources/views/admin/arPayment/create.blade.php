        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <br>
                    <div class="card-body">
                        <form action="{{ route('admin.ar-payment.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                            ...
                                            <div class="col-sm-3 ">
                                                <select name="invoice" id="invoice" class="form-control select2" required>
                                                    ...
                                                    @foreach($invoice as $row)
                                                        <option value="{{ $row->inv_number }}" data-total-payment="{{ $row->total_payment }}" 
                                                        data-paid-off="{{ $row->paid_off }}">
                                                            {{ $row->inv_number }} - {{ $row->customer->party_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
