                                        ...
                                        <select name="customer_currency" id="customer_currency" class="form-control select2" required>
                                            ...
                                            @foreach($currency as $row)
                                                @if($row->currency_code != "IDR")
                                                    <option value="{{$row->currency_code}}"  {{ old('customer_currency') == $row->currency_code ? 'selected' : '' }}> {{$row->currency_code}} - {{$row->currency_name}} </option>
                                                @endif
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-25">
                                    <div class="col-md-4">
                                        ...
                                        <select name="bill_to" id="bill_to" class="form-control select2" required>
                                            ...
                                            <option value="{{$row->cust_party_code}}"  {{ old('bill_to') == $row->cust_party_code ? 'selected' : '' }}> {{$row->party_name}} - {{$row->address1}}, {{$row->city}} </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="datepicker-1" name="ordered_date" class="form-control datepicker" value="{{ date('d-M-Y') }}" required>
                                ...
                                <div class="row mb-25">
                                    <div class="col-md-4">
                                        ...
                                        <select id="ship_to" name="deliver_to_org_id" class="form-control select2" required>
                                            @foreach($site as $row)
                                                <option value="{{$row->site_code}}">{{$row->address1}}, {{$row->city}} </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <!-- <div class="col-md-4">
                                        ...
                                        <select name="freight_terms_code" id="terms" class="form-control select2" required>
                                            ...
                                            <option value="{{$row->id}}" {{old('freight_terms_code') == $row->id ? 'selected' : '' }}> {{$row->term_code}} - {{$row->terms_name}} </option>
                                            @endforeach
                                        </select>
                                        @if($errors->has('terms'))
                                        <em class="invalid-feedback">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input autocomplete="off" type="text" id="terms_start" name="cust_po_number" class="form-control" value="{{ old('terms_start', isset($order) ? $order->terms_start : '') }}" required>
                                    ...
                                    <div class="col-md-2">
                                    <label class="form-label" for="payment_method">{{ trans('cruds.order.fields.paymentmethod') }}</label>
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label" for="currency">{{ trans('cruds.order.fields.tax') }}</label>
