                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-25">
                                    ...
                                    <input type="text" class="form-control" readonly autocomplete="off" maxlength="10" value="<?php echo e(auth()->user()->name); ?>" required>
                            ...
                            <div class="col-md-2">
                                <div class="mb-2">
                                    ...
                                    <input type="date" id="created_at" name="created_at" class="form-control" value="<?php echo e(date('d-M-Y H:i:s')); ?>" required>
                                </div>
                            </div>
                            <!-- <div class="col-md-1">
                                <div class="mb-2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/purchase/create.blade.php ENDPATH**/ ?>