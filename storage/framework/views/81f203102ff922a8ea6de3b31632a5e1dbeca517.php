...
<a href="<?php echo e(route("admin.rcv.index")); ?>" class="breadcrumbs__item"><?php echo e(trans('cruds.quotation.po')); ?> </a>
<a href="<?php echo e(route("admin.rcv.index")); ?>" class="breadcrumbs__item"><?php echo e(trans('cruds.rcv.title')); ?> </a>
<a href="" class="breadcrumbs__item active"><?php echo e(trans('cruds.rcv.fields.other')); ?> </a>
<?php $__env->stopSection(); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.rcvdirect-store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="mb-1">
                                    ...
                                    <select id="supplier" name="vendor_id" class="form-control select2 filter">
                                        ...
                                        <option value="<?php echo e($row->vendor_id); ?>"><?php echo e($row->vendor_name); ?> - <?php echo e($row->province); ?>, <?php echo e($row->country); ?></option>
                            ...
                            <div class="col-md-2 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="hidden" class="form-control" name="segment1" value="<?php echo e($po_number); ?>" autocomplete="off" maxlength="10" required>
