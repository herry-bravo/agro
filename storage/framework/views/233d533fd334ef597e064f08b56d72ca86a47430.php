            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a class="dropdown-item d-flex align-items-center dropdown-toggle" href="#" data-bs-toggle="dropdown" data-i18n="Purchase"><i data-feather="plus-square"></i><span data-i18n="Purchase">Purchase
                            ...
                            <ul class="dropdown-menu" data-bs-popper="none">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchaseOrder_access')): ?>
                                <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('admin.pr-detail.index')); ?>" data-bs-toggle="" data-i18n=""><i data-feather="check-circle"></i><span data-i18n="">PR Detail</span></a>
                                </li>
                                <?php endif; ?>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown"><i data-feather="book-open"></i><span data-i18n="User Interface">Accounting & GL</span></a>
                    <ul class="dropdown-menu" data-bs-popper="none">
                        ...
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('admin.faktur.index')); ?>" data-bs-toggle="" data-i18n=""><i data-feather="plus-square"></i><span data-i18n="">
                            e-Faktur</span></a>
                        </li>
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('admin.invoices.index')); ?>" data-bs-toggle="" data-i18n=""><i data-feather="plus-square"></i><span data-i18n="">
                            Invoice</span></a>
                        </li>
...
<!-- END: Main Menu-->
<?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>