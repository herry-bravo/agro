...
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <a href="<?php echo e(route('admin.tax.create')); ?>" class="breadcrumbs__item active"><?php echo e(trans('cruds.tax.fields.create')); ?></a>
...
<div class="card" >
    ...
    <br>
    <div class="card-body">
        <form id = "formship" action="<?php echo e(route("admin.tax.store")); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/tax/create.blade.php ENDPATH**/ ?>