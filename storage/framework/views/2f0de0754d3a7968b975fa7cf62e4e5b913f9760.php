                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-2">
                                                    ...
                                                    <input autocomplete="off" type="date" id="invoice_date" name="invoice_date" class="form-control flatpickr-basic-custom flatpickr-input active text-end" value="<?php echo e($DeliveryHeader->on_or_about_date); ?>" required>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/shipments/edit.blade.php ENDPATH**/ ?>