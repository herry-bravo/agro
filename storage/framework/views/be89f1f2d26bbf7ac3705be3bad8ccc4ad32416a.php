                    ...
                    },
                    {
                        render: function(data, type, row, index) {
                            ...
                            if (row.booked_flag == null || row.booked_flag === 'null' || row.booked_flag === '') {
                                deleteBtn = `<button type="button" class="badge btn btn-delete btn-danger btn-sm ms-1" data-index="${row.header_id}"><?php echo e(trans('global.delete')); ?></button>`;
                            }
                            <?php endif; ?>
                            content = `
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/sales/index.blade.php ENDPATH**/ ?>