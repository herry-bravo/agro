											...
											<tbody class="purchase_container">
												<?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $raw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<tr class="tr_input">
														...
														<td width="10%">
															<input type="text" readonly class="form-control" name="price[]" value="<?php echo e($raw->amount); ?>" autocomplete="off" required>
														</td>
														<td width="10%">
														...
														<td width="10%">
															<input readonly type="text" name="total[]" value="<?php echo e($raw->quantity_received * $raw->amount); ?>" class="form-control" id="need_1" autocomplete="off">
														</td>
													</tr>
                                        ...
                                        <table class="table table-fixed  table-borderless">
											...
											<tbody class="purchase_container">
												<?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <?php
                                                        $subtot = $row->quantity_received * $row->amount;
												...
												<?php $__currentLoopData = $detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                   <?php
                                                        $drValue = 0;
                                                        $crValue =  $row->quantity_received * $row->amount; // CR pada loop kedua selalu 0
                                                        $totalDr += $drValue;
                                                        $totalCr += $crValue;
                                                    ?>
                                                    <tr>
