        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <br>
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.ar-payment.store')); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-3 ">
                                                <select name="invoice" id="invoice" class="form-control select2" required>
                                                    ...
                                                    <?php $__currentLoopData = $invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($row->inv_number); ?>" data-total-payment="<?php echo e($row->total_payment); ?>" 
                                                        data-paid-off="<?php echo e($row->paid_off); ?>">
                                                            <?php echo e($row->inv_number); ?> - <?php echo e($row->customer->party_name); ?>
...
<script>
    $(document).ready(function() {
        $('#invoice').on('change', function() {
            ...
            var totalPayment = selected.data('total-payment');
            var paidOff = selected.data('paid-off');

            // Mengurangi total_payment dengan paid_off
            var amount = totalPayment - paidOff;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/arPayment/create.blade.php ENDPATH**/ ?>