    ...
    <form id="itemMasterForm" action="<?php echo e(route("admin.item-master.update", [$itemMaster->inventory_item_id])); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="bs-stepper wizard-modern modern-wizard-example">
            ...
            <div class="row mb-4">
                ...
                <div class="mt-2 col-6">
                    <div class="form-floating mb-0">
                        <textarea data-length="100" class="form-control char-textarea" id="textarea-counter" name="item_brand" rows="1" placeholder="Counter"><?php echo e($itemMaster->item_brand); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/itemMaster/edit.blade.php ENDPATH**/ ?>