                            ...
                            <div class="col-lg-12">
                                ...
                                <?php if($sales->open_flag != 12): ?>
                                    <a id="btn-kirim"
                                       ...
                                       href="<?php echo e(route('admin.salesorder.konfirmasi-kirim', $sales->id)); ?>"
                                       data-check="<?php echo e(route('admin.salesorder.check-stock', $sales->id)); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="row  mb-25">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" id="faktur" name="faktur" class="form-control" value="<?php echo e($sales->faktur); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/sales/edit.blade.php ENDPATH**/ ?>