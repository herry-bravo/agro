                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-1 col-md-4">
                                                            ...
                                                            <!-- <input type="text" class="form-control"
                                                                name="cust_party_code" 
                                                                value="<?php echo e($max->vendor_id); ?>"
                                                                placeholder="Party Site Code" readonly required="required"
                                                                maxlength="12" minlength="8"> -->
                                                        </div>
                                                        <div class="mb-1 col-md-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/vendor/create.blade.php ENDPATH**/ ?>