            ...
            <div class="card">
                <div class="card-header ">
                    <h6 class="card-title ">
                        ...
                        <a href="<?php echo e(route('admin.invoices.index')); ?>"
                            class="breadcrumbs__item"><?php echo e(trans('cruds.OrderManagement.faktur')); ?> </a>
                    </h6>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('price_list_create')): ?>
                        <div class="row">
                            <div class="col-lg-12">
                                <a class="btn btn-primary" href="<?php echo e(route('admin.faktur.create')); ?>">
                                    ...
                                    <?php echo e(trans('global.add')); ?> e-Faktur
                                </a>
                            </div>
                        </div>
                    <?php endif; ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table_sales = $('#salesindex').DataTable({
                "bServerSide": true,
                ajax: {
                    url: '<?php echo e(url('search/faktur-data')); ?>',
                    type: "GET",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
