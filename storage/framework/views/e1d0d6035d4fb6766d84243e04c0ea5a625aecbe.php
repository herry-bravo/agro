...
<div class="card">
    <div class="card-header">
        <h6 class="card-title">
            ...
            <a href="<?php echo e(route("admin.credit-memo.index")); ?>" class="breadcrumbs__item"> Credit Memo </a>
        </h6>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_create')): ?>
        <div class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="<?php echo e(route("admin.credit-memo.create")); ?>">
                    ...
                    <?php echo e(trans('global.add')); ?> Credit Memo
                </a>
            </div>
        </div>
        <?php endif; ?>
