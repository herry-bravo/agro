...
<head>
    ...
    <meta name="author" content="Buana Megah">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('app-assets/css/pages/page-misc.css')); ?>">
    <!-- END: Page CSS-->
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                    <a class="brand-logo" href="index.html">
                        <img class="img-fluid" src="<?php echo e(asset('app-assets/images/logo/bm.png')); ?>"  width="200px;" alt="svg3"/>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h1 class="title-big"><?php echo $__env->yieldContent('nilai'); ?></h1>
                            <h2 class="mb-1"><?php echo $__env->yieldContent('title'); ?></h2>
                            <h4 class="mb-1"><i><?php echo $__env->yieldContent('description'); ?></i></h4>
                            <a class="btn btn-primary mb-1 btn-sm-block" href="<?php echo e(route('admin.home')); ?>"><?php echo e(trans('global.back_to_home')); ?></a>
                            <p>
                                <?php $__env->startSection('nilai'); ?>
                                <?php if($nilai==401||$nilai==404): ?>
                                    <img class="img-fluid" src="<?php echo e(asset('app-assets/images/pages/coming-soon.png')); ?>" alt="Not authorized page" />
                                <?php elseif($nilai==403||$nilai==500): ?>
                                    <img class="img-fluid" src="<?php echo e(asset('app-assets/images/pages/not-authorized.svg')); ?>" alt="Not authorized page" />
                                <?php else: ?>
                                    <img class="img-fluid" src="<?php echo e(asset('app-assets/images/pages/error.png')); ?>" alt="Not authorized page" />
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
...
<?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/layouts/erorrs.blade.php ENDPATH**/ ?>