...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'laravel-views::components.dropdown.drop-down','data' => ['dropDownWidth' => 64,'label' => 'Filters']]); ?>
<?php $component->withName('lv-drop-down'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['dropDownWidth' => 64,'label' => 'Filters']); ?>
    ...
    <?php $__currentLoopData = $filtersViews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'laravel-views::components.dropdown.header','data' => ['label' => $filter->getTitle()]]); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\nexzo\agro\resources\views/vendor/laravel-views/components/toolbar/filters.blade.php ENDPATH**/ ?>