...
<div class="card">
    <div class="card-header">
        <h6 class="card-title">
            <a href="<?php echo e(route("admin.purchase-requisition.index")); ?>" class="breadcrumbs__item">Purchase Requisition Detail </a>
        </h6>
...
<script>
    $(document).ready(function() {
        ...
        const table = $('#pr-detail').DataTable({
            "bServerSide": true
            , ajax: {
                url: '<?php echo e(url("search/pr-detil")); ?>'
                , type: "POST"
                , headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/purchaserequisitiondetail/index.blade.php ENDPATH**/ ?>