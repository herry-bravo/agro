    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo $__env->yieldContent('pageTitle'); ?> Edit Cart Of Account</h5>
            ...
            <form class="form-horizontal" id="formData" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-1 col-md-4">
                            <label class="form-label" for="account_receivable"><?php echo e(trans('cruds.coa.fields.code')); ?></label>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-1 col-md-4">
                            <label class="form-label" for="account_receivable"><?php echo e(trans('cruds.coa.fields.level')); ?></label>
...
<?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/acc/editModal.blade.php ENDPATH**/ ?>