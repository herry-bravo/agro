...
<div class="card">
    <div class="card-header">
        <h6 class="card-title">
            ...
            <a href="<?php echo e(route("admin.materialTrnTypes.index")); ?>" class="breadcrumbs__item">  <?php echo e(trans('cruds.materialTrnTypes.title_singular')); ?> </a>
        </h6>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role_create')): ?>
        <div class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="<?php echo e(route("admin.materialTrnTypes.create")); ?>">
                    ...
                    <?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.materialTrnTypes.title_singular')); ?>
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-materialTrnTypes">
                <thead>
                    <tr>
                        ...
                        <th>
                            <?php echo e(trans('cruds.materialTrnTypes.fields.trx_code')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.materialTrnTypes.fields.trx_type')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.materialTrnTypes.fields.trx_action')); ?>

                        </th>
                        <th>
                            <?php echo e(trans('cruds.materialTrnTypes.fields.trx_source_types')); ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $mtrl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($row->id); ?>">
                            <td>

                            </td>
                            <td>
                                <?php echo e($row->trx_code ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($row->trx_types ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($row->trx_actions ?? ''); ?>

                            </td>
                            <td>
                                <?php echo e($row->trx_source_types ?? ''); ?>

                            </td>
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('item_show')): ?>
                                <a class="btn btn-primary btn-sm " href="<?php echo e(route('admin.materialTrnTypes.show', $row->id)); ?>">
                                    <?php echo e(trans('global.view')); ?>

                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('item_edit')): ?>
                                    <a class="btn btn-warning btn-sm waves-effect waves-float waves-light" href="<?php echo e(route('admin.materialTrnTypes.edit', $row->id)); ?>">
                                        <?php echo e(trans('global.edit')); ?>

                                    </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('item_delete')): ?>
                                    <form action="<?php echo e(route('admin.materialTrnTypes.destroy', $row->id)); ?>" method="POST"  style="display: inline-block;">
