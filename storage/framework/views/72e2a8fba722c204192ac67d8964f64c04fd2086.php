                ...
                <div class=" box-body">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-12">
                            <div class="mb-1">
                                <label class="col-sm-0 control-label" for="number"><?php echo e(trans('cruds.rcv.fields.orderno')); ?></label>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-1">
                                <label class="col-sm-0 control-label" for="site"><?php echo e(trans('cruds.rcv.fields.rev')); ?></label>
                        ...
                        <div class="col-md-2 col-12">
                            <div class="mb-1">
                                <label class="col-sm-0 control-label" for="rate"><?php echo e(trans('cruds.rcv.fields.etd')); ?></label>
                        ...
                        <div class="col-md-2 col-12">
                            <div class="mb-1">
                                <label class="col-sm-0 control-label" for="rate"><?php echo e(trans('cruds.rcv.fields.eta')); ?></label>
    ...
    $('#refreshAtp').click(function() {
        ...
        if (document.getElementById('rev').value === "") {
            var table = $('#atp-id').DataTable({
                ...
                , "bLengthChange": false
                , ajax: {
                    url: '<?php echo e(url("search/po-atp")); ?>'
                    , type: "POST"
                    , headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
            ...
            var table = $('#atp-id').DataTable({
                ...
                , "bLengthChange": false
                , ajax: {
                    url: '<?php echo e(url("search/atp-data")); ?>'
                    , type: "POST"
                    , headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/purchase/atp-reply.blade.php ENDPATH**/ ?>