                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="mb-25">
                                    ...
                                    <input readonly type="text" id="datepicker-1_" name="created_at" class="form-control form-control flatpickr-basic flatpickr-input" value=" <?php echo e($purchaseorder->created_at); ?>" required>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-fixed  table-borderless">
                                        ...
                                        <tbody class="purchase_container">
                                            ...
                                            <tr class="tr_input">
                                                ...
                                                <td width="15%">
                                                    <input type="text" class="form-control stock_total text-end" name="sub_total[]" value="<?php echo e(number_format(($raw->attribute1), 2, ',', '.')); ?>" id="total_1"="" readonly="">
                                                </td>
                                                <!-- <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro\resources\views/admin/purchase/edit.blade.php ENDPATH**/ ?>