    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header  bg-primary">
                <h4 class="modal-title text-white" id="exampleModalLongTitle"><?php echo e(trans('cruds.autocreate.title')); ?> Invoice</h4>
...
<?php /**PATH C:\laragon\www\nexzo\agro\resources\views/admin/arAuto/invoiceType.blade.php ENDPATH**/ ?>