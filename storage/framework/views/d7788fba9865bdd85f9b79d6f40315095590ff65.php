        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.gl.update', $data->je_header_id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <select name="currency_code" id="currency" class="form-control select2">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\agro_nexzo_app\resources\views/admin/glmanual/edit.blade.php ENDPATH**/ ?>